...
def get_bayes_search_spaces():
    return {
        'Logistic Regression': _get_logistic_regression_space(),
        'Decision Tree': _get_decision_tree_space(),
        'Random Forest': _get_random_forest_space(),
        'Gradient Boosting': _get_gradient_boosting_space(),
        'SVM': _get_svm_space(),
        'KNN': _get_knn_space(),
        'XGBoost': _get_xgboost_space()
    }
