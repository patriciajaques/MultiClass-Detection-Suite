...
def create_selectors(X_train, y_train):
    ...
    selectors = {
        'rfe': create_selector('rfe', X_train=X_train, y_train=y_train, n_features_to_select=min(10, n_features)),
        'pca': create_selector('pca', X_train=X_train, n_components=min(5, n_features)),
